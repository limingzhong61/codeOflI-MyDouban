...
body {
	margin: 0;
	background-image: url('${WEB_PATH}/image/portrait/登录背景设置.jpg');
...
<form action="${WEB_PATH}/LoginServlet" method="post" id="login_form">
	...
	<!-- 获取cookie中的对象的值 -->
	 ...
	 <!-- 验证码的输入框 + 验证码图片 -->
		...
		<div class="verify_inner">
				...
				<img src="${WEB_PATH}/VerifyCodeServlet" width="80" height ="42" id="verify_pic">
		</div>
		</div>
...
<!-- 重定位到登陆界面 -->
	 <c:redirect url="http://127.0.0.1/${WEB_PATH}/jsp/alter.jsp" />
</c:if>
    ...
    function check(){
	    ...
	    document.getElementById("btn").onclick = function () {
	        ...
	        document.getElementsByTagName("img")[0].src =
	            "${WEB_PATH}/VerifyCodeServlet?time=" + new Date().getTime();
	    	};
	</script>
