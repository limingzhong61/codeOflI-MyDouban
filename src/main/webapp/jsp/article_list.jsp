									...
									<div class="item">
								        ...
								        <div class="header">
								            ...
								            <div class="author-img">
								                <a href="${WEB_PATH}/ArticleShowServlet?method=article_show&article_id=${a.articleId}" target="_blank" style="margin: 5px 0px 5px 5px;">
								                	<img src="${a.authorImg}" style="width: 20px;height: 20px;border-radius: 2px;">
								                </a>
								            <!--作者的昵称 -->
								            <a href="${WEB_PATH}/ArticleShowServlet?method=article_show&article_id=${a.articleId}" target="_blank"  id="author-nickname" style="margin: 5px 0px 5px 5px;color:black;">${a.authorNick} </a>
								            </div>
								        ...
								        <div class="bottom">
								         ...
								         <c:if test="${requestScope.msg=='我的文章'}">
									        <div >
											  <a href="${WEB_PATH}/ArticleListServlet?pre_method=delete_article&method=my_article_list&article_id=${a.articleId}" class="user_operation_btn" id="delete_article" style="color: red;"  onclick= "return confirm('你确定要删除这篇文章吗？删除之后将会永久删除，请慎重操作！！！')">删除</a>
											</div>
									    </c:if>
									    <c:if test="${requestScope.msg=='我的文章'}">
									    	<div >
